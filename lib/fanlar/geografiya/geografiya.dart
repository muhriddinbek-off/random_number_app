...
class Geografiya extends StatefulWidget {
  const Geografiya({super.key});

  @override
  State<Geografiya> createState() => _GeografiyaState();
}

class _GeografiyaState extends State<Geografiya> {
  int quetionsnum = 0;
