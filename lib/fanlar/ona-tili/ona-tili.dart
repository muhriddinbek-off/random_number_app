...
import 'package:random_number_app/core/get_number.dart';
import 'package:random_number_app/provider/changeprovider.dart';

class OnaTili extends StatefulWidget {
  const OnaTili({super.key});

  @override
  State<OnaTili> createState() => _OnaTiliState();
}

class _OnaTiliState extends State<OnaTili> {
  int quetionsnum = 0;
