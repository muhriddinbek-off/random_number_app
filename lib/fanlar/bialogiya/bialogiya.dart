...
class Bialogiya extends StatefulWidget {
  const Bialogiya({super.key});

  @override
  State<Bialogiya> createState() => _BialogiyaState();
}

class _BialogiyaState extends State<Bialogiya> {
  int quetionsnum = 0;
